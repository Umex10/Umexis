...
export function renderHeader() {
  return `
    ...
    <section class="mx-auto flex max-w-7xl flex-row items-center justify-between p-4"   role="banner" aria-label="Site header">
      ...
      <!-- Right Buttons -->
      <div class="ml-auto flex flex-row items-center gap-1.5 md:gap-3">
    ...
    <section id="mobile-menu"
      class="section-min-height absolute top-full mt-1 hidden w-full origin-top animate-open-menu flex-col items-center rounded-lg border border-white/20 bg-black/50 backdrop-blur-md" role="region" aria-label="Mobile menu overlay">
      <!-- Nav Bar (Mobile only) -->
